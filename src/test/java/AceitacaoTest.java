//package com.ibm.b5.setembro1.test;
...
//import com.ibm.b5.setembro1.resolucoes.TomasAvelino;
...
public class AceitacaoTest {
    ...
    public void testOrganizarTimes() {
        var solucao = new LarissaSimoesService();
        ...
        Map<String, List<String>> times2 = solucao.organizarTimes(jogadores2);
        ...
        Map<String, List<String>> times3 = solucao.organizarTimes(jogadores3);
        ...
        Map<String, List<String>> times4 = solucao.organizarTimes(jogadores4);
        ...
        List<String> jogadores5 = Arrays.asList("Lionel Messi", "Lucas Messi", "Cristiano Ronaldo", "Carlos Ronaldo", "Neymar Jr.");
        Map<String, List<String>> times5 = solucao.organizarTimes(jogadores5);
        assertEquals(5, times5.size(), "Caso de teste 5: Jogadores com sobrenomes diferentes e iguais em letras diferentes");
        ...
        Map<String, List<String>> times6 = solucao.organizarTimes(jogadores6);
        ...
        List<String> jogadores7 = Arrays.asList("Lionel Messi", "lucas messi", "Cristiano Ronaldo", "carlos Ronaldo", "Neymar Jr.");
        Map<String, List<String>> times7 = solucao.organizarTimes(jogadores7);
        ...
        Map<String, List<String>> times8 = solucao.organizarTimes(jogadores8);
        ...
        List<String> jogadores10 = Arrays.asList("Lionel Messi", "Cristiano Ronaldo", "Neymar Jr.", "123ABC Adams", "1st Place");
        Map<String, List<String>> times10 = solucao.organizarTimes(jogadores10);
